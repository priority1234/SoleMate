                                    ...
                                    <div className="flex gap-4 mb-6">
                                        {user
                                            ...
                                            <Link to={'/login'}>
                                                <Button
                                                    type="button"
                                                    className="w-96 px-4 py-3 text-center text-gray-100 bg-indigo-600 border border-transparent dark:border-gray-700 hover:border-indigo-500 hover:text-indigo-700 hover:bg-indigo-100 rounded-xl"
                                                >
                                                    Buy now
                                                </Button>
                                            </Link>
