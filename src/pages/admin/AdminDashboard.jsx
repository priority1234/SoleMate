        ...
        <div className="mid mb-5">
          ...
          <div className=" bg-indigo-50 py-5 rounded-xl border border-indigo-100">
            ...
            <div className="flex justify-center space-x-3 mt-2">
              <Link to={"/addproduct"}>
                <Button className=" py-2 bg-indigo-500">Add Product</Button>
              </Link>
              <Button className=" py-2 bg-indigo-500" onClick={logout}>
                Logout
              </Button>
            </div>
          </div>
            ...
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              ...
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer outline-none">
                <div className=" border bg-indigo-50 hover:bg-indigo-100 border-indigo-100 px-4 py-3 rounded-xl">
                  ...
                  <p className=" text-indigo-500  font-bold">Total User</p>
                </div>
              </Tab>
            </TabList>
